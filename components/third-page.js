        ...
        <div className="h-full">
            ...
            <div className="flex">
                <div className="m-auto w-4/5">
                    ...
                    <p className="text-sm md:text-base text-justify">&nbsp;&nbsp;&nbsp;
                        Sebelumnya website ini sudah pernah saya buat, namun karena ada permasalahan yang agak sulit diselesaikan jadi saya berpindah menggunakan framwork lain 
                        berdasarkan rekomendasi beberapa orang terdekat. Wesbite sebelumnya dibuat dengan menggunakan Vuejs dan <a href="https://buefy.org" target="_blank" className="text-sky-400 font-bold">Buefy</a> dan saya upload juga ke <a href="https://docs.github.com/en/pages/getting-started-with-github-pages/about-github-pages" target="_blank" className="text-sky-400 font-bold">Github Pages</a>.
